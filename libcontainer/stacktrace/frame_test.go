...
func TestParsePackageName(t *testing.T) {
	var (
		name             = "github.com/Freeaqingme/opencontainers-runc/libcontainer/stacktrace.captureFunc"
		expectedPackage  = "github.com/Freeaqingme/opencontainers-runc/libcontainer/stacktrace"
